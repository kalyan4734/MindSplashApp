...
public class FragmentTheroems extends Fragment {

    private static FragmentTheroems fragmentTheroems;
    private RecyclerView rclDefinitions;
    private static String subjId, chapId;
    private AdapterDefinition adapterDefinition;
    private static List<String> theorems;


    public static Fragment getInstance(List<String> theoremsList) {
        theorems = theoremsList;
        if (fragmentTheroems == null)
            fragmentTheroems = new FragmentTheroems();
        return fragmentTheroems;
    }
