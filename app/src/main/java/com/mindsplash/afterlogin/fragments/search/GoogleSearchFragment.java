...
public class GoogleSearchFragment extends Fragment implements OnClickVideo {

    private static final String ARG_PARAM1 = "param1";
    private String searchTerm;
    private AdapterGoogle adapterGoogle;
    ...
    public static GoogleSearchFragment newInstance(String param1) {
...
//       String cx = "87e319d5a706116e6";
    ...
    private void setChapters(ArrayList<Item> data) {
        try {
            adapterGoogle = new AdapterGoogle(data,requireContext(),this);
